 ...
 * </pre>
 * @class
 * @memberof Addons.EconomicTransports
 */
export class CommuterApi {
    ...
    getListStates (onsuccess, onerror) {
        ...
        this.getFilterCall(url, {
            ...
            filter: [
                [{
                    propertyName: "euvm:wvstart",
                    literal: "TRUE"
                },
                {
                    propertyName: "euvm:wvziel",
                    literal: "TRUE"
                }]
            ]
        }, xmlResponse => {
    ...
    getFeaturesDistrict (district, homeToWork, start, len, onsuccess, onerror) {
        ...
        this.getFilterCall(url, {
            featureType: homeToWork ? "wv_start" : "wv_ziel",
            filter: [{
                propertyName: homeToWork ? "euvm:teilverkehrszellen" : "euvm:teilverkehrszellen",
                literal: district
            }]
        }, xmlText => {
            const rawFeatureList = this.convertXmlToFeatureList(xmlText, homeToWork ? "wv_start" : "wv_ziel"),
                translatedFeatureList = this.translateFeatureList(
                    rawFeatureList,
                    homeToWork ? "zielort" : "startort",
                    "anzahl",
