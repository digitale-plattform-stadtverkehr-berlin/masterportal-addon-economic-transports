...
export default {
    ...
    computed: {
        ...mapGetters("Tools/EconomicTransports", Object.keys(getters)),
    ...
    methods: {
        ...mapMutations("Tools/EconomicTransports", Object.keys(mutations)),
        thousandsSeparator,
        /**
        ...
        close () {
            ...
            const model = Radio.request("ModelList", "getModelByAttributes", {id: this.$store.state.Tools.EconomicTransports.id});
        ...
        <template #toolBody>
            ...
            >
                    ...
                    <div class="col">
                        ...
                        >
                            <label for="EconomicTransports-select-state">
                                {{ translate("additional:modules.tools.EconomicTransports.labelState") }}
                            </label>
                            <select
                            ...
                            >
                                <option
                                    ...
                                    value=""
                                >
                                    {{ translate("additional:modules.tools.EconomicTransports.selectState") }}
                                </option>
                                <option
                        ...
                        <div class="col">
                            ...
                            >
                                <label for="EconomicTransports-select-district">
                                    {{ translate("additional:modules.tools.EconomicTransports.labelDistrict") }}
                                </label>
                                <select
                                ...
                                >
                                    <option
                                        ...
                                        value=""
                                    >
                                        {{ translate("additional:modules.tools.EconomicTransports.selectDistrict") }}
                                    </option>
                                    <option
                ...
                <div v-if="lastDataset !== null">
                        ...
                        <div class="col">
                            <div class="form-group">
                                <label for="EconomicTransports-select-city">
                                    {{ translate("additional:modules.tools.EconomicTransports.labelCity") }}
                                </label>
                                <select
                                ...
                                >
                                    <option
                                        ...
                                        value=""
                                    >
                                        {{ (listCities.length > 0)?translate("additional:modules.tools.EconomicTransports.selectCity") : translate("additional:modules.tools.EconomicTransports.noCity") }}
                                    </option>
                                    <option
                    ...
                    <div class="d-grid section">
                        <div class="d-grid">
                            <div class="form-check">
                                ...
                                >
                                    {{ translate("additional:modules.tools.EconomicTransports.checkName") }}
                                </label>
                            </div>
                        </div>
                        <div class="d-grid">
                            <div class="form-check">
                                ...
                                >
                                    {{ translate("additional:modules.tools.EconomicTransports.checkNumber") }}
                                </label>
                            </div>
                        </div>
                        <div class="d-grid">
                            <div class="form-check">
                                ...
                                <label
                                    ...
                                    for="idBeamsChecked"
                                >
                                    {{ translate("additional:modules.tools.EconomicTransports.checkBeams") }}
                                </label>
                            </div>
                        </div>
                        <div class="d-grid d-md-flex section">
                            <div class="col-md-6">
                                <div class="form-check">
                                    ...
                                    >
                                        {{ translate("additional:modules.tools.EconomicTransports.checkAnimation") }}
                                    </label>
                                </div>
                            </div>
                            <div class="col-md-4 ms-auto">
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        {{ translate("additional:modules.tools.EconomicTransports.buttonStart") }}
                                    </button>
                                </div>
                                <div
                                    v-else
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        {{ translate("additional:modules.tools.EconomicTransports.buttonStop") }}
                                    </button>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="d-grid section">
                        <div class="col" />Die Analyse der Wirtschaftsverkehrs wurde auf Grundlage von Floating Car-Daten für September 2021 durchgeführt. Die Verkehrsteilnehmer wurden auf den Flottentyp und die Gewichtsklasse gefiltert und ihre Start und Zielgebiete ermittelt.
                    </div>
                    <div class="d-grid d-md-flex section">
                        <div class="col-6 col-sm-6 tooltipWrapper">
                            ...
                            >
                                ...
                                <label
                                    ...
                                    for="idOutChecked"
                                >
                                    {{ translate("additional:modules.tools.EconomicTransports.selectOut") }}
                                </label>
                            </div>
                            <div
                                ...
                                class="tooltip"
                            >
                                {{ translate("additional:modules.tools.EconomicTransports.tooltipOut") }}
                            </div>
                        </div>
                        <div class="col-6 col-sm-6 tooltipWrapper">
                            <div
                            ...
                            >
                                ...
                                <label
                                    ...
                                    for="idInChecked"
                                >
                                    {{ translate("additional:modules.tools.EconomicTransports.selectIn") }}
                                </label>
                            </div>
                            <div
                            ...
                            >
                                {{ translate("additional:modules.tools.EconomicTransports.tooltipIn") }}
                            </div>
                        </div>
                    </div>
                    <div class="d-grid">
                    ...
                    <div class="d-grid section">
                                ...
                                <tbody>
                                    ...
                                    >
                                        ...
                                        <td class="featurePeople">
                                            {{ translate("additional:modules.tools.EconomicTransports.labelPeople") }}
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
                        ...
                        >
                            {{ translate("additional:modules.tools.EconomicTransports.noDataset") }}
                        </div>
                    </div>
                    <div class="d-grid">
                        <div class="col">
                    ...
                    <div class="d-grid gap-2 d-md-block section buttons">
                        <button
                            ...
                            @click="loadLess"
                        >
                            {{ translate("additional:modules.tools.EconomicTransports.buttonLess", {listChunk}) }}
                        ...
                        <button
                            ...
                            @click="loadMore"
                        >
                            {{ translate("additional:modules.tools.EconomicTransports.buttonMore", {listChunk}) }}
                        ...
                        <button
                            ...
                            @click="loadAll"
                        >
                            {{ translate("additional:modules.tools.EconomicTransports.buttonAll") }}
                        </button>
                    </div>
                    <div
                        v-if="metaVerPath"
                    ...
                    >
                        <div class="col-sm-12">
                            <a
                                ...
                                class="float-end"
                            >
                                {{ translate("additional:modules.tools.EconomicTransports.linkMoreInfo") }}
                            </a>
                        </div>
                    </div>
                    <div class="d-grid mx-auto section">
                        ...
                        >
                            ...
                            {{ translate("additional:modules.tools.EconomicTransports.buttonReset") }}
                        </button>
                    </div>
                </div>
            </div>
